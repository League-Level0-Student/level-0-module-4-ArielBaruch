...
public class FruitQuiz extends KeyAdapter {
	...
	void makeQuestions() {
		...
		// 11. Make another question called "question2".  Use question1 above as a guide.
				question2 = new JLabel("<html>Which is not a real fruit? <br> I: Luminosity <br> D: Pomegranate <br> K: Carambola</html>");
				question3 = new JLabel("<html> Which is real? <br> J: Watermelone <br> R: Mangano <br> W: Pear</html>");
	}
	@Override
