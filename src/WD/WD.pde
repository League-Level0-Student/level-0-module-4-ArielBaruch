void setup() {
  PImage waldo = loadImage("waldo3.jpg"); // Change this to match your file name.
  size(500, 500);
...
println("X: " + mouseX + " Y: " + mouseY);
  ...
  if( mouseX==276 && mouseY==382){
  playWoohoo();
  } 
  if( mouseX==275 && mouseY==381){
  playWoohoo();
  } 
   if( mouseX==274 && mouseY==380){
  playWoohoo();
  } 
  if( mouseX==274 && mouseY==382){
  playWoohoo();
  } 
  if( mouseX==277 && mouseY==385){
  playWoohoo();
  } 
  if( mouseX==279 && mouseY==389){
  playWoohoo();
  } 
