...
public class HappyPet {
	...
	public static void main(String[] args) {
		...
		String pet = JOptionPane.showInputDialog("What kind of pet do you want to buy at the store?");
		// 7. REPEAT steps 3 - 6 enough times to make your pet happy!
		JOptionPane.showConfirmDialog(null, "That's an intresting pet_isn't it?");
		...
		int task = JOptionPane.showOptionDialog(null, "what do you want to do to make your pet happy", "", 0, JOptionPane.INFORMATION_MESSAGE, null,
					new String[] {"cuddle", "take a walk", "play" }, null);
			...
			if(happinessLevel == 10) {
				JOptionPane.showMessageDialog(null, "You sure do love your pet");
				break;
			}
